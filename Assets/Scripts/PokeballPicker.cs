...
{
    public enum PokeballStatus
    {
        Empty,
        Occupied
    }
    /// <summary>
    /// Modified copy of HandDraggable.cs script. 
    /// Added code is for the gravity to properly work after dragging is done
    /// </summary>
    public class PokeballPicker : MonoBehaviour,
                                 IFocusable,
                                 IInputHandler,
                                 ISourceStateHandler

    {
        public PokeballStatus PokeballStats;
        /// <summary>
